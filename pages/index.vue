...
<template>
  <Hero>
    <Columns>
      ...
      <template #right>
        <NuxtImg src="/images/landing/home/hero.webp" />
      </template>
    </Columns>
  </Hero>
  <Content>
    <Columns>
      ...
      <template #right>
        <NuxtImg src="/images/landing/home/search.webp" />
      </template>
    </Columns>
    <Columns>
      <template #left>
      ...
      <template #right>
        <NuxtImg src="/images/landing/home/ask.webp" />
      </template>
    </Columns>
    <Columns>
      <template #left>
      ...
      <template #right>
        <NuxtImg src="/images/landing/home/onboarding.webp" />
      </template>
    </Columns>
  </Content>
  <Section>
