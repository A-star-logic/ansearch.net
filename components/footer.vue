...
.footer-wrapper {
  ...
  @apply bg-stone-700 text-white py-4;
  ...
  footer {
    ...
    .brand {
      ...
      .brand-title {
        ...
        line-height: 1;
        border: 1px solid;
        @apply py-4 px-8 border-brand-200 rounded-lg bg-gradient-to-br from-brand-300 to-brand-700;
